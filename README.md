...
- create MVP of a search bar that connects to openfoodfacts and gets back all the necesarry info (+ discards the unnecesarry info because ther is A LOT of info there)
...
- get produce data from a nutrition API (like openfoodfacts, might revisit this later)
